...
Version  : 0.34.2
Release  : 54
URL      : https://github.com/certbot/certbot/archive/v0.34.2/certbot-0.34.2.tar.gz
Source0  : https://github.com/certbot/certbot/archive/v0.34.2/certbot-0.34.2.tar.gz
...
BuildRequires : pytest-rerunfailures
...
export LANG=C
export SOURCE_DATE_EPOCH=1557671447
export AR=gcc-ar
